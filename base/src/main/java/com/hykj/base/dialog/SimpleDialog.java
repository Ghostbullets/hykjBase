...
public class SimpleDialog extends DialogFragment {
    ...
    public SimpleDialog setData(CharSequence mTitle, CharSequence mMessage, CharSequence mPositiveButtonText, CharSequence mNegativeButtonText) {
        this.mTitle = mTitle;
    ...
    public SimpleDialog setListener(OnSelectClickListener listener) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_simple_confirm, container);
